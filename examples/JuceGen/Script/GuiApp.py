...
def generate_project(project):
  ...
  project["bundleIdentifier"] = "com.myhandle.guiapp"
  ...
  paths = ["examples/JuceGen/GuiApp/Source"]
  ...
  files = ["examples/JuceGen/GuiApp/Source/" + cxx_filters_deep]
...
def make_plugin(name):
  ...
  generate_project(JuceGen.JuceProject(ctx,name,"guiapp",["XCODE_MAC","XCODE_IPHONE","VS2019","VS2022","LINUX_MAKE","ANDROIDSTUDIO"])).save()
